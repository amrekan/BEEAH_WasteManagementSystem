...
public class CusDeleteAccount extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cus_delete_account);
                                            ...
                                            public void onComplete(@NonNull Task<Void> task) {
                                                if (task.isSuccessful()) {
                                                   // ref.getRef().removeValue();
                                                    ...
                                                    Toast.makeText(CusDeleteAccount.this, "Account Deleted,", Toast.LENGTH_LONG).show();
                                                    SharedPreferences sharedPreferences = getSharedPreferences(SHARED_PREFS, MODE_PRIVATE);
                                                    SharedPreferences.Editor editor= sharedPreferences.edit();
                                                    editor.clear();
                                                    editor.commit();
                                                    firebaseAuth.signOut();
                                                    startActivity(new Intent(CusDeleteAccount.this, SelectUser.class));
                                                    finish();
    ...
    public void onBackPressed() {
        super.onBackPressed();
        startActivity(new Intent(CusDeleteAccount.this, Home.class));
        finish();
    }
}