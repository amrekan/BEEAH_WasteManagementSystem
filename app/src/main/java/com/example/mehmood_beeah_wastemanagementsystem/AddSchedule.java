...
public class AddSchedule extends AppCompatActivity {
    ...
    private void processinsert(String title, String date, String time) {
        ...
        if (firebaseUser != null) {
            DatabaseReference ref = FirebaseDatabase.getInstance().getReference("Users").child(firebaseUser.getUid()).child("Tasks");
        ...
        mTitledit.setText("");
        Toast.makeText(this, "Task Scheduler Set Successfully", Toast.LENGTH_SHORT).show();
        startActivity(new Intent(AddSchedule.this, Home.class));
        finish();
